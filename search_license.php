                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-12" colspan="2" style="padding: 10px !important;">
                                        <input class="form-control input-sm" id="FilterKeySearch" placeholder="ค้นหาเลขใบอนุญาต">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    '<div class="table-responsive" style="width: 240px;">' +
                                        '<table class="table table-bordered" style="margin: 0;">' +
                                            '<thead>' +
                                                ...
                                                /*'<th class="text-nowrap text-center" style="font-size: 10px;">เลขที่ใบอนุญาตผลิต</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">เลขที่ใบอนุญาตจำหน่ายสุรา</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">เลขที่ใบอนุญาตขนสุรา</th>' +*/
                                            '</thead>' +
                                            '<tbody>' +
                                                '<th class="text-nowrap" style="font-size: 10px;">' + hit.get('FACTORY_TNAME') +'</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">' + hit.get('REGISTER_CODE') +'</th>' +
                                                '<th class="text-nowrap text-center" style="font-size: 10px;">' + hit.get('REGISTER_CODE') +'</th>' +
                                            '</tbody>' +
                                        '</table>' +
                                    '</div>' +
