        ...
        <div class="row">
            ...
            <div class="header">
                <nav class="navbar navbar-default header-menu">
                    <div class="container-fluid">
                        <div class="navbar-header"><a class="navbar-brand header-logo" href="#" style="padding-top: 5px;"><img src="img/logoheader.png"></a></div>
                ...
                <div class="user-menu-detail hide">
                    ...
                    <div class="col-md-12 user-menu-detail-btn text-center">              
                        <div class="col-md-6 text-left">
                            <div class="row">
                                <a href="#" class="btn btn-default" id="settingAccount">ตั้งค่าบัญชี</a>
                            </div>
                        </div>
                        <div class="col-md-6 text-right">
                            <div class="row">
                                <a href="#" class="btn btn-default" id="logout">ออกจากระบบ</a>
                            </div>
                        </div>
                    </div>
                </div>
