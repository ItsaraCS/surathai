                ...
                <div class="panel panel-default" style="border-radius: 0; border: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <table class="table table-striped search-detail-table" style="margin-top: 0; margin-bottom: 0;">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-5"><p>โรงงาน</p></td>
                                    <td class="col-md-7 text-center"><span id="Factory"></span></td>
                                </tr>
                                <tr>
                                    <td class="col-md-5"><p>แบรนด์</p></td>
                                    <td class="col-md-7 text-center"><span id="Brand"></span></td>
                                </tr>
