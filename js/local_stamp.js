...
function load_data_by_year(year) {
	if(year != '' && year != undefined) {
		load_data_region('API/taxmapAPI.php?data=stamp_reg&year='+ year);
		load_data_region_monthly('API/taxmapAPI.php?data=stamp_month&year='+ year);
		load_data_area('API/taxmapAPI.php?data=stamp_area&year='+ year);
