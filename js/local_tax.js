...
function load_data_by_year(year) {
	if(year != '' && year != undefined) {
		load_data_region('API/taxmapAPI.php?data=tax_reg&year='+ year);
		load_data_region_monthly('API/taxmapAPI.php?data=tax_month&year='+ year);
		load_data_area('API/taxmapAPI.php?data=tax_area&year='+ year);
