...
function load_data_by_year(year) {
	if(year != '' && year != undefined) {
		load_data_region('API/taxmapAPI.php?data=illegal_reg&year='+ year);
		load_data_region_monthly('API/taxmapAPI.php?data=illegal_month&year='+ year);
		load_data_area('API/taxmapAPI.php?data=illegal_area&year='+ year);
